...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('uploads_mass_destroy', ['uses' => 'UploadsController@massDestroy', 'as' => 'uploads.mass_destroy']);
    Route::resource('tview', 'tPostController');
    Route::post('tview_mass_destroy', ['uses' => 'tPostController@massDestroy', 'as' => 'tview.mass_destroy']);
...
// Route::get('/triv',[PostController::class,'index']);

// Route::get('/create',
// return view('triv.create');
// );

// Route::post('/post',[PostController::class,'store']);
// Route::delete('/delete/{id}',[PostController::class,'destroy']);
// Route::get('/triv.edit/{id}',[PostController::class,'triv.edit']);
